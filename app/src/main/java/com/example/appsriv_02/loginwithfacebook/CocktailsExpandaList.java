...
public class CocktailsExpandaList extends Activity

{
    private ExpandListAdapterForCocktailsItems ExpAdapter;
   ...
   // ParserTask parserTask;
    ...
    private static final String TAGG = CocktailsExpandaList.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.cocktails_expandablelistlayout);
        ...
        shareDialog = new ShareDialog(CocktailsExpandaList.this);
     ...
     //   ExpListItems = Group.bottleSort(SetStandardGroups());
       ...
       /* ExpAdapter = new ExpandListAdapterForBeerItems(NewExpandaList.this, ExpListItems, ExpandList);
        ...
        {
            Toast.makeText(CocktailsExpandaList.this,"please try again",Toast.LENGTH_LONG).show();
        }
        if (ExpAdapter != null)
        {
       ...
       // atvPlaces.setDropDownBackgroundResource(R.drawable.my_shape1);
        ...
        gps = new GPSTracker(CocktailsExpandaList.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            {
                if (isInternetPresent) {
                    Intent intent = new Intent(CocktailsExpandaList.this, ResultActivity.class);
                    ...
                    Toast.makeText(CocktailsExpandaList.this, "Please try again ", Toast.LENGTH_SHORT).show();
                }
                    ...
                    if (place.length() != 0) {
                        ...
                        if (jsonObject.length() != 0) {
                            ...
                            if (jarr != null) {
                                ...
                                Intent shopIntent = new Intent(CocktailsExpandaList.this, Wineclass.class);
                                shopIntent.putExtra("city", place);
                                startActivity(shopIntent);
                            } else {
                                showAlertDialog(CocktailsExpandaList.this, "Alert", "No Data Found for Current Location", false);
                            }
                        } else {
                            showAlertDialog(CocktailsExpandaList.this, "Alert", "No data found for your location", false);
                        }
                    } else {
                        JSONArray nearByBar = null;
...
*/
        pint.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                ExpandListAdapterForCocktailsItems.minPrice.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/MYRIADPRO_REGULAR.OTF"), Typeface.BOLD);
                CocktailsExpandaList.pint.setBackgroundResource(R.drawable.yellowtab);
                CocktailsExpandaList.bottle.setBackgroundResource(R.drawable.whitetab);
        ...
        bottle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/MYRIADPRO_REGULAR.OTF");
                ExpandListAdapterForCocktailsItems.price.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MYRIADPRO_REGULAR.OTF"));
                ...
                CocktailsExpandaList.pint.setBackgroundResource(R.drawable.whitetab);
                CocktailsExpandaList.bottle.setBackgroundResource(R.drawable.yellowtab);
    ...
    private void look_further_popup(final Context context)
    {
        ...
        LayoutInflater layoutInflater = (LayoutInflater)CocktailsExpandaList.this.getSystemService(context.LAYOUT_INFLATER_SERVICE);
     ...
     /*   if (latlng.size()>0) {*/
         //   final Double latitude = (Double) latlng.get(0);
            ...
            sevenkm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    Toast.makeText(CocktailsExpandaList.this, "7 km restaurants are showing", Toast.LENGTH_SHORT).show();
...
*/
                                    ...
                                    showAlertDialog(CocktailsExpandaList.this, "Alert", "No Data Found within " + km + "km", false);
                                }
                    ...
                    if (lkflag) {
                        ...
                        showAlertDialog(CocktailsExpandaList.this, "Alert", "No Restaurants found in 7 Km", false);
            ...
            fivekm.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(CocktailsExpandaList.this, "5 km restaurants are showing", Toast.LENGTH_SHORT).show();
            ...
            twokm.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(CocktailsExpandaList.this, "2 km restaurants are showing", Toast.LENGTH_SHORT).show();
                     ...
                     /* */
                        ...
                        lookfurther.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                if (isInternetPresent)
                                {
                                look_further_popup(CocktailsExpandaList.this);
                                }
                                else {
                                    Toast.makeText(CocktailsExpandaList.this,"Please try again ",Toast.LENGTH_SHORT).show();
                                }
                        ...
                        showAlertDialog(CocktailsExpandaList.this, "Alert", "No Data Found Please Try other place", false);
                        ;
                    }
    ...
    {
        Intent intent = new Intent(CocktailsExpandaList.this,Homescreen.class);
    ...
    private class AsyncCallWS extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            try {
                progressDialog = ProgressDialog.show(CocktailsExpandaList.this, "Please wait", "Loading...", true);
        ...
        protected String doInBackground(String... params)
        {
            ...
            CocktailsExpandaList.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ExpListItems = Group.bottleSort(SetStandardGroups());
                }
        ...
        protected void onPostExecute(String result)
        {
            if (ExpListItems.size()>0) {
                ExpAdapter = new ExpandListAdapterForCocktailsItems(CocktailsExpandaList.this, ExpListItems, ExpandList);
                ExpandList.setAdapter(ExpAdapter);
