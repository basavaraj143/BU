...
public class ExpandListAdapterForCocktailsItems extends BaseExpandableListAdapter implements SectionIndexer, AbsListView.OnScrollListener
{
  ...
  //  RelativeLayout[] relative_layout=newlayout RelativeLayout[10000];
   ...
   // ImageView[] offerribben = new ImageView[10000];
    ...
    public ExpandListAdapterForCocktailsItems(Context context, ArrayList<Group> groups, ExpandableListView expandableListView)
    {
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent)
    {
      ...
      Child child = (Child) getChild(groupPosition, childPosition);
        ...
        if (convertView == null)
        {
            ...
            convertView = infalInflater.inflate(R.layout.cocktails_child, null);
        }
...
//        line.getLayoutParams().width=linewidth-13;
       ...
       // timeText.setTextColor(Color.BLACK);
        time.setText(CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourStart().substring(0,5)
                + "-" + CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourEnds().substring(0,5));
...
//        childdist.setTypeface(tf);
       // childdist.setText(group.getDist() + "km");
        ...
        if (CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourStart().substring(0,5).equalsIgnoreCase("00:00")
                &&CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourEnds().substring(0,5).equalsIgnoreCase("00:00"))
        {
        ...
        arrowup.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                CocktailsExpandaList.ExpandList.collapseGroup(groupPosition);
                //Toast.makeText(context, "collapsed", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        direction[groupPosition].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CocktailsExpandaList.mTracker.send(new HitBuilders.EventBuilder()
...
*/
    ...
    public void onGroupExpanded(int groupPosition)
    {
        ...
        CocktailsExpandaList.mTracker.send(new HitBuilders.EventBuilder()
                .setCategory(CocktailsExpandaList.ExpListItems.get(groupPosition).getName())
                .setAction("Restaurant")
                .setLabel(CocktailsExpandaList.ExpListItems.get(groupPosition).getName())
                .build());
    }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inf.inflate(R.layout.cocktailsgroup, null);
        }
...
*/
       // View line =(View)convertView.findViewById(R.id.line);
        ...
        time.setText(CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourStart().substring(0,5)
                + "-" + CocktailsExpandaList.ExpListItems.get(groupPosition).getHappyHourEnds().substring(0,5));
        if (CocktailsExpandaList.activeColumn.equalsIgnoreCase("pint"))
        {
...
*/
            ...
            CocktailsExpandaList.pint.setTypeface(tfb,Typeface.BOLD);


        }
        else if (CocktailsExpandaList.activeColumn.equalsIgnoreCase("bottle"))
        {
             Typeface tfb=Typeface.createFromAsset(context.getAssets(),"fonts/MYRIADPRO_REGULAR.OTF");
           /* minpricelayout[groupPosition].setBackgroundColor(Color.parseColor("#ffffff"));
            ...
            CocktailsExpandaList.bottle.setTypeface(tfb,Typeface.BOLD);
...
*/
          ...
          //  grpnamelayout.setBackgroundResource(R.drawable.threesiderectangle);
            ...
            if (CocktailsExpandaList.ExpListItems.get(groupPosition).getRest_offers_happy_hour().equalsIgnoreCase("no"))
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (CocktailsExpandaList.ExpListItems.get(groupPosition).getIsHappyHours().equalsIgnoreCase("no"))
                    {
    ...
    private void addressPopUp(final Context context,final int value)
    {
       ...
       // popupWindow.showAsDropDown(direction, 10, 10);
        ...
        address.setText(CocktailsExpandaList.ExpListItems.get(value).getPlaceName());
...
//28.63875,77.07380
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=" + latitude + "," + longitude + "&daddr=" + CocktailsExpandaList.ExpListItems.get(value).getRes_lat() +
                        "," + CocktailsExpandaList.ExpListItems.get(value).getRes_lng() + ""));
