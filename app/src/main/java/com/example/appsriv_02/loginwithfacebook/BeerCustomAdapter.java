...
public class BeerCustomAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public BeerCustomAdapter(Activity a, ArrayList<Child> d,ArrayList<Group> groups)
    {
        activity = a;
        data=d;
        this.groups=groups;
