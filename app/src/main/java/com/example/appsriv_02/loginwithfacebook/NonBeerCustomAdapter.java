...
public class NonBeerCustomAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public NonBeerCustomAdapter(Activity a, ArrayList<Child> d ,ArrayList<Group> groups) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            /****** Inflate beer_list_child_itemst_child_item.xml file for each row ( Defined below ) *******/
            vi = inflater.inflate(R.layout.non_beer_list_item, null);

            /****** View Holder Object to contain beer_list_child_item.xmlhild_item.xml file elements ******/
        ...
        //TextView time = (TextView)vi.findViewById(R.id.time);
            ...
            if (position==0)
            {
                ...
                distance.setText(groups.get(position).getDist());
            }
            String PRICE = checkZeroValue(data.get(position).getMinPrice());
//            String PRICE=checkZeroValue(groups.get(position).getItems().get(position).getMinPrice());
