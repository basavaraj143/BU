...
public class DealsCustomAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public DealsCustomAdapter(Activity a, ArrayList<Child> d, ArrayList<Group> groups) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            vi = inflater.inflate(R.layout.deals_list_items, null);
        ...
        //TextView time = (TextView)vi.findViewById(R.id.time);
           ...
           /* if (position==0)
            ...
            String PRICE = checkZeroValue(data.get(position).getPrice());
